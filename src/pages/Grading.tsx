...
const Grading = () => {
...

        {
          ...
          answers: [
            ...
            },
            {
              ...
              maxPoints: 2,
              feedback:
                'Błąd w obliczeniach — upewnij się, że mnożysz poprawne wartości.',
            },
          ],
        },
      ],
          ...
          answers: [
            {
              questionId: 9,
              question:
                "Choose the correct form: 'I ___ (see) this movie three times.'",
            ...
            },
            {
              questionId: 10,
              question:
                "Choose the correct form: 'She ___ (go) to Paris last year.'",
              studentAnswer: 'went',
              correctAnswer: 'went',
              pointsAwarded: 2,
              maxPoints: 2,
          ...
          answers: [
            {
              ...
              maxPoints: 2,
              feedback:
                'To jest Present Perfect — czynność powtarzana w życiu.',
            },
            {
              questionId: 12,
              question:
  ...
  const numberOfStudentsInTest = currentTest.students?.length ?? 0;
  ...
  return (
    <div className="flex flex-col gap-5 items-start">
      ...
      <div className="grid grid-cols-7 w-full gap-6">
        <StudentsList
          studentsList={currentTest.students ?? []}
        ...
        <TestsView
          ...
          test={currentTest}
          setStudentId={setStudentId}
          numberOfStudents={numberOfStudentsInTest}
        />
      </div>
    </div>
  );
